...
1. CPU: minor  
   _Από το [starter-se.py](https://github.com/Rallu921/ArchProject1/blob/main/starter_se.py):_  
   >CPU frequency: 1GHz  
...
3. Τα [stats](https://github.com/Rallu921/ArchProject1/blob/main/hello_result/stats.txt) από το Hello world βρίσκονται στο hello_results και από αυτά προκύπτει:  
   >Total-Inst-num=5027  
   >IL1.miss-num=372  
   >DL1.miss-num=177  
   >L2.miss-num=474  
...
Το πρόγραμμα C που γράψαμε είναι στο project1/code/[simplecode.c](https://github.com/Rallu921/ArchProject1/blob/main/project1/code/simplecode.c).  
Τα στατιστικά βρίσκονται στους φακέλους [proj-re-minor](https://github.com/Rallu921/ArchProject1/tree/main/proj_re_minor) και [proj-re-timing](https://github.com/Rallu921/ArchProject1/tree/main/proj_re_timing) για το MinorCPU και το TimingSimpleCPU αντίστοιχα. Μέσα σε κάθε φάκελο υπάρχουν οι φάκελοι "default", "clock", "mem" και "comb" για τα αρχικά χαρακτηριστικά, clock στα 3GHz, τύπο μνήμης DDR4-2400-4x16 και συνδυασμό του clock=3GHz και της μνήμης DDR4-2400-4x16 αντίστοιχα. Στους φακέλους αυτούς βρίσκονται τα αντίστοιχα αρχεία _config.dot_, _config.dot.pdf_, _config.dot.svg_, _config.ini_, _config.json_, _stats.txt_  
